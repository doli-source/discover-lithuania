...
(async function () {
  ...
  const FAQ_QUERIES_V = '20260920h';

  const PLAIN_SCRIPTS = ['/faq-data.js?v=20260920h'];

  const JSX_SCRIPTS = [
    '/tweaks-panel.jsx?v=20260626b',
    '/shared.jsx?v=20260921a',
    '/screens.jsx?v=20260921a',
    '/app.jsx?v=20260921a',
  ];
  ...
  try {
    ...
    PLACES.push({
      ...
      status:  'approved',
      source:  'niv',
      lat:     55.72069093161048,
      lng:     21.154540880189668,
      hours:   'Closes 19:00',
      hoursHe: 'סגירה 19:00',
