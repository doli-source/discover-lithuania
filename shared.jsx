...
const STRINGS = {
  ...
  en: {
    ...
    kinds: { all: 'All', cafe: 'Cafés', restaurant: 'Restaurants', market: 'Markets & Bars', culture: 'Culture', nature: 'Nature', stay: 'Stays', wellness: 'Wellness', activity: 'Activities', bar: 'Bars', info: 'Visitor info' },
    minutes: 'min',
    day: 'day',
    week: 'week',
    weekend: 'wknd',
