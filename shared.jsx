...
const STRINGS = {
  he: {
    ...
    nav: { home: 'בית', explore: 'גלה', routes: 'מסלולים', food: 'אוכל', stays: 'לינה', blog: 'בלוג', about: 'על ליטא' },
    kinds: { all: 'הכל', cafe: 'בתי קפה', restaurant: 'מסעדות', market: 'שוק / בר', culture: 'תרבות', nature: 'טבע', stay: 'לינה', wellness: 'וולנס' },
    minutes: 'דק׳',
    day: 'יום',
    week: 'שבוע',
    weekend: 'סופ״ש',
  ...
  en: {
    ...
    nav: { home: 'Home', explore: 'Explore', routes: 'Routes', food: 'Food', stays: 'Stays', blog: 'Blog', about: 'About' },
    kinds: { all: 'All', cafe: 'Cafés', restaurant: 'Restaurants', market: 'Markets & Bars', culture: 'Culture', nature: 'Nature', stay: 'Stays', wellness: 'Wellness' },
    minutes: 'min',
    day: 'day',
    week: 'week',
    weekend: 'wknd',
...
const Icon = {
  ...
  calendar: (props) => <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/></svg>
};
