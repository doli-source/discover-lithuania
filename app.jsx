...
function App() {
  ...
  useEffect(() => {
    ...
    let description = lang === 'he'
      ? 'מדריך טיולים אישי לליטא — 142 מקומות נבחרים: בתי קפה, מסעדות, אתרי טבע ולינה, ב-12 אזורים. מאת ניב שמעוני.'
      : "A curated travel guide to Lithuania — 142 handpicked cafés, restaurants, stays, nature spots and ready-made routes across 12 regions. By Niv Shimoni.";
