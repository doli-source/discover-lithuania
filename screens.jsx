          ...
          {dishes.map((f, i) => (
            <article className="dish-card" key={f.id}>
              <div className="dish-visual" style={{ background: (((f.bg||'').match(/#[0-9a-f]{6}/i)||['#A85D4A'])[0])+'0d', '--dish-color': ((f.bg||'').match(/#[0-9a-f]{6}/i)||['#A85D4A'])[0] }}>
                {f.liquid ? <svg viewBox="0 0 100 80" width="120" height="96" style={{flexShrink:0}}><path d="M8 36 Q10 74 50 74 Q90 74 92 36 Z" fill={f.liquid}/><ellipse cx="50" cy="36" rx="42" ry="11" fill="#e8d5b0"/><ellipse cx="50" cy="36" rx="36" ry="8" fill={f.liquid}/><ellipse cx="38" cy="33" rx="14" ry="4" fill="white" opacity="0.18"/><ellipse cx="50" cy="36" rx="42" ry="11" fill="none" stroke="#c9a870" strokeWidth="2"/><path d="M8 36 Q10 74 50 74 Q90 74 92 36" fill="none" stroke="#c9a870" strokeWidth="2.5" strokeLinecap="round"/>{f.spoon && <><line x1="86" y1="3" x2="67" y2="44" stroke="#a0a0a0" strokeWidth="6" strokeLinecap="round"/><line x1="86" y1="3" x2="67" y2="44" stroke="#787878" strokeWidth="2" strokeLinecap="round"/><ellipse cx="65" cy="51" rx="11" ry="7.5" transform="rotate(-25 65 51)" fill="#c8c8c8" stroke="#888" strokeWidth="1.5"/><ellipse cx="64" cy="50" rx="6.5" ry="4.5" transform="rotate(-25 64 50)" fill={f.liquid} opacity="0.7"/></>}</svg> : <span className="dish-emoji">{f.emoji || '🍲'}</span>}
              </div>
