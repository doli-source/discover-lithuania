        ...
        {region.id === 'vilnius' && (
          <a
            ...
            style={{
              ...
              gap: '12px', background: 'var(--tint)', border: '1px solid var(--primary)',
              borderRadius: '10px', padding: '12px 16px', margin: '0 0 10px',
            ...
            <span style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              <span>
                <strong style={{ display: 'block', fontSize: '14px', color: 'var(--ink)' }}>
                  {lang === 'he' ? '8 המסעדות הכי טובות בווילנה' : '8 Best Restaurants in Vilnius'}
                </strong>
        ...
        {region.id === 'vilnius' && (
          ...
          >
            <span style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              <span>
                <strong style={{ display: 'block', fontSize: '14px', color: 'var(--ink)' }}>
                  {lang === 'he' ? '7 בתי הקפה הכי טובים בווילנה' : '7 Best Coffee Shops in Vilnius'}
                </strong>
                <span style={{ fontSize: '12px', color: 'var(--primary)' }}>
                  {lang === 'he' ? 'מדריך מקומי ← קרא עכשיו' : 'Local guide · Read now →'}
                </span>
              ...
              <div className="dish-visual" style={{ background: (((f.bg||'').match(/#[0-9a-f]{6}/i)||['#A85D4A'])[0])+'0d', '--dish-color': ((f.bg||'').match(/#[0-9a-f]{6}/i)||['#A85D4A'])[0] }}>
                {f.liquid
                  ? <div style={{position:'relative',display:'inline-flex',alignItems:'center',justifyContent:'center'}}>
                      <svg viewBox="0 0 100 80" width="120" height="96"><path d="M8 36 Q10 74 50 74 Q90 74 92 36 Z" fill={f.liquid}/><ellipse cx="50" cy="36" rx="42" ry="11" fill="#e8d5b0"/><ellipse cx="50" cy="36" rx="36" ry="8" fill={f.liquid}/><ellipse cx="38" cy="33" rx="14" ry="4" fill="white" opacity="0.18"/><ellipse cx="50" cy="36" rx="42" ry="11" fill="none" stroke="#c9a870" strokeWidth="2"/><path d="M8 36 Q10 74 50 74 Q90 74 92 36" fill="none" stroke="#c9a870" strokeWidth="2.5" strokeLinecap="round"/></svg>
                      {f.spoon && <svg viewBox="0 0 120 120" width="120" height="120" style={{position:'absolute',top:0,left:0,pointerEvents:'none'}}><path d="M105 8 L72 88" stroke="#6b6b6b" strokeWidth="9" strokeLinecap="round"/><path d="M105 8 L72 88" stroke="#aaa" strokeWidth="5" strokeLinecap="round"/><ellipse cx="69" cy="96" rx="15" ry="10" transform="rotate(-28 69 96)" fill="#b8b8b8" stroke="#777" strokeWidth="1.5"/><ellipse cx="68" cy="95" rx="9" ry="6" transform="rotate(-28 68 95)" fill={f.liquid} opacity="0.8"/></svg>}
                    </div>
